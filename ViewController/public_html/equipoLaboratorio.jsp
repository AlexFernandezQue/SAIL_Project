                ...
                <div class="col-md-10" style="height:500px">
                                    ...
                                    <br/><br/><br/><br/><br/><br/><font size="4">
                                        <strong>
                                            <font size="5" color="#ff0000">
                                                <h:outputLabel value="Lista de Equipos por Laboratorio"/>
                                            </font></strong>
                                    </font>
                                     
                                    <br/><br/>
                                </div>
                                                                <h:dataTable value="#{beanAsignarEquipoLab.listaEquipos}"
                                                                             var="equipo" border="4"
                                                 style="width:800px; color:Black; font-weight:bold; text-align:center; font-size:150%; background-color:ActiveCaption;">
                                                                        <%-- 
                                                                                oracle-jdev-comment:Faces.RI.DT.Class.Key:SAIL_Proyecto.equipo
                                                                        --%>
                                                                        <h:column>
                                                                                <f:facet name="header">
                                                                        ...
                                                                        <h:column>
                                                                                <f:facet name="header">
                                                                                        <h:outputText value="Numero Compu"/>
                                                                                </f:facet>
                                                                                <h:outputText value="#{equipo.numeroCompu}"/>
                                                                        </h:column>
                                                                        <h:column>
                                                                                <f:facet name="header">
                    ...
                    <div class="col-md-2">
                                    ...
                                    <h:commandButton styleClass="btn btn-info" value="Editar" style="width:80px;"
                                                     action="#{beanAsignarEquipoLab.ActualizarEquipob}"/>
                                    <br/><br/>
                                    <h:commandButton styleClass="btn btn-info" value="Nuevo" style="width:80px;"
                                                     action="#{beanAsignarEquipoLab.nuevoEquipo}"/>
                                    <br/><br/>
