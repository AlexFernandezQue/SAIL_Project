...
<f:view>
    <html>
        <head>
            ...
            <title>Modulo Olvido de Contraseña</title>
                            ...
                            <div class="col-md-offset-2 col-md-8" align="center">
                               <br></br>
                                ...
                                <font size="7" color="#c60000">
                                    <strong>
                                        <font size="4">
                                            <h:outputLabel style="width:200px;" value="#{beanOlvidoContra.mensaje}"/>
                                        </font></strong>
                                </font>
                            </div>
                        </div>
                                            ...
                                            <strong>
                                                <font color="#000000">
                                                    <h:inputText style="width:200px;"
                                                                 value="#{beanOlvidoContra.usuario}"
                                                                 readonly="false"/>
                                                </font></strong>
                                        </font>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <font color="#000000" size="4">
                                            <h:selectOneMenu style="width:200px;"
                                                             value="#{beanOlvidoContra.preguntaClave}">
                                    ...
                                    <div class="col-md-6">
                                        <font size="4">
                                            <strong>
                                                <font color="#000000">
                                                    <h:inputText style="width:200px;"
                                                                 value="#{beanOlvidoContra.respuesta}"
                                                                 readonly="false"/>
                                                </font></strong>
                                        </font>
                                    </div>
  ...
  border-radius: 6px;" id="btnAceptar" action="#{beanOlvidoContra.OlvidoClave}"/></strong>
                            </font>
                             &nbsp;&nbsp;&nbsp;<font size="3">
                                <strong>
